...
export function useRiskRadar(rawKlines: RawKlinesMap): RiskRadarState {
  return useMemo(() => {
    ...
    // Golden LONG MEGA (🥇): QUADRUPLE — MACD 0-50 + EMA±0.5% + ATR<0.3% + HTF FLAT
    // Forward test 2.3Y: WR 71.8% · N=163 · PF 4.69 · Exp +1.92%/trade
    {
      const c1 = macd1h.histogram !== null && macd1h.histogram >= 0 && macd1h.histogram < 50;
      const c2 = emaDist1h !== null && Math.abs(emaDist1h) < 0.5;
      const c3 = atrPct1h !== null && atrPct1h < 0.3;
      const c4 = htf4hState === "FLAT";
      goldens.push({
        id: "golden_long_quadruple",
        side: "LONG",
        title: "LONG QUADRUPLE MEGA (🥇)",
        wr: "WR 71.8% · N=163 · PF 4.69",
        tpSl: "TP +5% / SL -2%",
        conditions: [
          { label: "MACD Hist 1h 0..50", live: macd1h.histogram !== null ? macd1h.histogram.toFixed(1) : "n/a", pass: c1 },
          { label: "|EMA50 Δ 1h| < 0.5%", live: emaDist1h !== null ? `${emaDist1h >= 0 ? "+" : ""}${emaDist1h.toFixed(2)}%` : "n/a", pass: c2 },
          { label: "ATR 1h < 0.3%", live: atrPct1h !== null ? `${atrPct1h.toFixed(2)}%` : "n/a", pass: c3 },
          { label: "HTF 4h FLAT", live: htf4hState, pass: c4 },
        ],
        allPass: c1 && c2 && c3 && c4,
      });
    }

    // Golden LONG #1 (🥈): MACD 0-50 + EMA±0.5% + HTF FLAT (1h)
    // Forward test 2.3Y: WR 64.9% · N=405 · PF 3.90 · Exp +1.94%/trade
    {
      const c1 = macd1h.histogram !== null && macd1h.histogram >= 0 && macd1h.histogram < 50;
      const c2 = emaDist1h !== null && Math.abs(emaDist1h) < 0.5;
      const c3 = htf4hState === "FLAT";
      goldens.push({
        id: "golden_long_macd_flat",
        side: "LONG",
        title: "LONG TRIPLE MACD+EMA+FLAT (🥈)",
        wr: "WR 64.9% · N=405 · PF 3.90",
        tpSl: "TP +5% / SL -2%",
        conditions: [
          { label: "MACD Hist 1h 0..50", live: macd1h.histogram !== null ? macd1h.histogram.toFixed(1) : "n/a", pass: c1 },
          { label: "|EMA50 Δ 1h| < 0.5%", live: emaDist1h !== null ? `${emaDist1h >= 0 ? "+" : ""}${emaDist1h.toFixed(2)}%` : "n/a", pass: c2 },
          { label: "HTF 4h FLAT", live: htf4hState, pass: c3 },
        ],
        allPass: c1 && c2 && c3,
      });
    }

    // Golden LONG #2 (🥉): MACD 0-50 + ATR<0.3% + HTF FLAT (MỚI — verified via forward test)
    // Forward test 2.3Y: WR 67.4% · N=181 · PF 3.82 · Exp +1.72%/trade
    {
      const c1 = macd1h.histogram !== null && macd1h.histogram >= 0 && macd1h.histogram < 50;
      const c2 = atrPct1h !== null && atrPct1h < 0.3;
      const c3 = htf4hState === "FLAT";
      goldens.push({
        id: "golden_long_macd_atr_flat",
        side: "LONG",
        title: "LONG TRIPLE MACD+ATR+FLAT (🥉)",
        wr: "WR 67.4% · N=181 · PF 3.82",
        tpSl: "TP +5% / SL -2%",
        conditions: [
          { label: "MACD Hist 1h 0..50", live: macd1h.histogram !== null ? macd1h.histogram.toFixed(1) : "n/a", pass: c1 },
    ...
    // Golden LONG #3: ATR<0.3% + EMA±0.5% + HTF FLAT
    // Forward test 2.3Y: WR 60.4% · N=323 · PF 2.59 · Exp +1.22%/trade
    {
      const c1 = atrPct1h !== null && atrPct1h < 0.3;
      const c2 = emaDist1h !== null && Math.abs(emaDist1h) < 0.5;
      const c3 = htf4hState === "FLAT";
      goldens.push({
        id: "golden_long_atr_ema_flat",
        side: "LONG",
        title: "LONG SILENT + CENTER",
        wr: "WR 60.4% · N=323 · PF 2.59",
        tpSl: "TP +5% / SL -2%",
        conditions: [
          { label: "ATR 1h < 0.3%", live: atrPct1h !== null ? `${atrPct1h.toFixed(2)}%` : "n/a", pass: c1 },
          { label: "|EMA50 Δ 1h| < 0.5%", live: emaDist1h !== null ? `${emaDist1h >= 0 ? "+" : ""}${emaDist1h.toFixed(2)}%` : "n/a", pass: c2 },
          { label: "HTF 4h FLAT", live: htf4hState, pass: c3 },
        ],
        allPass: c1 && c2 && c3,
    ...
    // Golden LONG #3 (pair, N lớn hơn): ATR<0.3% + HTF FLAT — WR 81%, N=84
    {
      const c1 = atrPct1h !== null && atrPct1h < 0.3;
      const c2 = htf4hState === "FLAT";
      goldens.push({
        id: "golden_long_atr_flat",
        side: "LONG",
        title: "LONG 1H SILENT (🥉, N lớn)",
        wr: "WR 81.0% · N=84",
        tpSl: "TP +5% / SL -2%",
        conditions: [
          { label: "ATR 1h < 0.3%", live: atrPct1h !== null ? `${atrPct1h.toFixed(2)}%` : "n/a", pass: c1 },
          { label: "HTF 4h FLAT", live: htf4hState, pass: c2 },
        ],
        allPass: c1 && c2,
      });
    }

    // Golden LONG #4 (Plan C): emaCrossBull + atrLow + htf:FLAT
    // Forward test 2.3Y: WR 68.3% · N=104 · PF 3.44 · Exp +1.45%/trade
    {
      const c1 = emaCrossBull === true;
      const c2 = atrPct1h !== null && atrPct1h < 0.3;
      const c3 = htf4hState === "FLAT";
      goldens.push({
        id: "golden_long_cross_silent",
        side: "LONG",
        title: "LONG EMA CROSS BULL + SILENT",
        wr: "WR 68.3% · N=104 · PF 3.44",
        tpSl: "TP +5% / SL -2%",
        conditions: [
          { label: "EMA20 > EMA50 (1h)", live: emaCrossBull === null ? "n/a" : (emaCrossBull ? "BULL" : "BEAR"), pass: c1 },
          { label: "ATR 1h < 0.3%", live: atrPct1h !== null ? `${atrPct1h.toFixed(2)}%` : "n/a", pass: c2 },
          { label: "HTF 4h FLAT", live: htf4hState, pass: c3 },
        ],
        allPass: c1 && c2 && c3,
    ...
    // Golden LONG #5 (Plan C): bodySmall + macdBull + htf:FLAT
    // Forward test 2.3Y: WR 63.7% · N=259 · PF 3.64 · Exp +1.78%/trade
    {
      const c1 = bodyPct1h !== null && bodyPct1h < 0.1;
      const c2 = macd1h.histogram !== null && macd1h.histogram >= 0 && macd1h.histogram < 50;
      const c3 = htf4hState === "FLAT";
      goldens.push({
        id: "golden_long_doji_macd",
        side: "LONG",
        title: "LONG DOJI + MACD BULL",
        wr: "WR 63.7% · N=259 · PF 3.64",
        tpSl: "TP +5% / SL -2%",
        conditions: [
          { label: "body 1h < 0.1% (doji)", live: bodyPct1h !== null ? `${bodyPct1h.toFixed(2)}%` : "n/a", pass: c1 },
          { label: "MACD Hist 1h 0..50", live: macd1h.histogram !== null ? macd1h.histogram.toFixed(1) : "n/a", pass: c2 },
          { label: "HTF 4h FLAT", live: htf4hState, pass: c3 },
        ],
        allPass: c1 && c2 && c3,
      });
    ...
    // Golden LONG #6 (Plan C): bbSqueeze + macdBull + htf:FLAT
    // Forward test 2.3Y: WR 62.3% · N=369 · PF 3.50 · Exp +1.79%/trade
    {
      const c1 = bbWidth1h !== null && bbWidth1h < 1.5;
      const c2 = macd1h.histogram !== null && macd1h.histogram >= 0 && macd1h.histogram < 50;
      const c3 = htf4hState === "FLAT";
      goldens.push({
        id: "golden_long_bb_squeeze",
        side: "LONG",
        title: "LONG BB SQUEEZE + MACD BULL",
        wr: "WR 62.3% · N=369 · PF 3.50",
        tpSl: "TP +5% / SL -2%",
        conditions: [
          { label: "BB width < 1.5% (squeeze)", live: bbWidth1h !== null ? `${bbWidth1h.toFixed(2)}%` : "n/a", pass: c1 },
          { label: "MACD Hist 1h 0..50", live: macd1h.histogram !== null ? macd1h.histogram.toFixed(1) : "n/a", pass: c2 },
          { label: "HTF 4h FLAT", live: htf4hState, pass: c3 },
        ],
        allPass: c1 && c2 && c3,
